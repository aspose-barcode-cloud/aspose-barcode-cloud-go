...
// RecognizeAPIBarcodeRecognizeGetOpts - Optional Parameters for RecognizeAPIBarcodeRecognizeGet
type RecognizeAPIBarcodeRecognizeGetOpts struct {
	RecognitionMode      optional.Interface
	RecognitionImageKind optional.Interface
}

/*
* BarcodeRecognizeGet -  Recognize barcode from file on server using GET requests with parameters in route and query string.
* @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
* @param barcodeType Type of barcode to recognize
* @param fileUrl Url to barcode image
* @param optional nil or *RecognizeAPIBarcodeRecognizeGetOpts - Optional Parameters:
...
* @return BarcodeResponseList
*/
func (a *RecognizeAPIService) BarcodeRecognizeGet(ctx context.Context, barcodeType DecodeBarcodeType, fileUrl string, optionals *RecognizeAPIBarcodeRecognizeGetOpts) (BarcodeResponseList, *http.Response, error) {
	var (
...
// RecognizeAPIBarcodeRecognizeMultipartPostOpts - Optional Parameters for RecognizeAPIBarcodeRecognizeMultipartPost
type RecognizeAPIBarcodeRecognizeMultipartPostOpts struct {
	RecognitionMode      optional.Interface
	RecognitionImageKind optional.Interface
}

/*
* BarcodeRecognizeMultipartPost -  Recognize barcode from file in request body using POST requests with parameters in multipart form.
* @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
* @param barcodeType
* @param file Barcode image file
* @param optional nil or *RecognizeAPIBarcodeRecognizeMultipartPostOpts - Optional Parameters:
...
* @return BarcodeResponseList
*/
func (a *RecognizeAPIService) BarcodeRecognizeMultipartPost(ctx context.Context, barcodeType DecodeBarcodeType, file *os.File, optionals *RecognizeAPIBarcodeRecognizeMultipartPostOpts) (BarcodeResponseList, *http.Response, error) {
	var (
		httpMethod    = strings.ToUpper("Post")
		postBody      interface{}
		fileName      string
