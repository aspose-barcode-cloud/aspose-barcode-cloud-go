...
/*
* BarcodeScanBodyPost -  Scan barcode from file in request body using POST requests with parameter in body in json or xml format.
* @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
* @param scanBase64Request Barcode scan request

* @return BarcodeResponseList
 */
func (a *ScanAPIService) BarcodeScanBodyPost(ctx context.Context, scanBase64Request ScanBase64Request) (BarcodeResponseList, *http.Response, error) {
	var (
